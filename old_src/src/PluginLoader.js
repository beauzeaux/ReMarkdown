define(
    ['../../lib/dojo-release-1.9.2-src/dojo/_base/lang', 'dojo/_base/declare', 'dojo/string'],
        ...
        var PluginLoader = declare(null, {
            ...
            _loadPlugins: function () {
                ...
                for (var o in this._pluginList) {
                    define('loader', this)
                    var path = dojoString.substitute("ReMarkdownPlugins/${name}/${name}.js", {name: this._pluginList[o]});
